...
const StoryNode = ({ id, data }: NodeProps<AppNode>) => {
  ...
  return (
    <div className="group relative">
      ...
      <div className="absolute right-[-10px] top-6 translate-x-1/2"><CustomHandle type="source" position={Position.Right} isConnectable className="!border-white/40 !bg-[#2b2b2b]" /></div>
    </div>
  );
};
